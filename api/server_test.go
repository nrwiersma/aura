...
func (m *mockApp) AppsFind(_ context.Context, q aura.AppsQuery) (*aura.App, error) {
	args := m.Called(q)
	if args.Get(0) == nil {
...
func (m *mockApp) ReleasesFind(_ context.Context, q aura.ReleasesQuery) (*aura.Release, error) {
	args := m.Called(q)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
